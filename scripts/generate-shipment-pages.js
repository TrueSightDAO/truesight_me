        ...
        <div style="margin-bottom: var(--space-lg);">
          <div style="margin-bottom: var(--space-md);">
            ...
            <ul style="list-style: none; padding: 0; margin: 0; display: flex; flex-wrap: wrap; justify-content: center; gap: var(--space-sm) var(--space-lg);">
              <li><a href="https://truesight.me/physical-asset-locations" target="_blank" rel="noreferrer noopener" style="color: var(--muted); text-decoration: none; font-size: 0.9375rem;">Asset Locations</a></li>
        ...
        <ul class="nav-menu" aria-hidden="true">
          ...
          <li>
            ...
            <ul class="dropdown-menu" aria-expanded="false">
              ...
              <li><a href="https://truesight.me/proposals" target="_blank" rel="noreferrer noopener">Community Proposals</a></li>
              <li><a href="https://truesight.me/governors" target="_blank" rel="noreferrer noopener">Community Leaders</a></li>
              <li><a href="https://truesight.me/submissions/scored-and-to-be-tokenized" target="_blank" rel="noreferrer noopener">Community Awards</a></li>
            </ul>
          </li>
          <li>
            ...
            <ul class="dropdown-menu" aria-expanded="false">
              ...
              <li><a href="../../faq.html#tokenomics">Community Economics</a></li>
              ...
              <li><a href="https://truesight.me/submissions/raw-telegram-chatlogs" target="_blank" rel="noreferrer noopener">Community Engagement Logs</a></li>
            </ul>
          </li>
